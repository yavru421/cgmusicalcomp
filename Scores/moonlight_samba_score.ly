...
fluteConcert = \relative c'' {
  ...
  r4. gis'8\f ~ gis8 gis16 gis gis8. gis16 |
  gis4. gis8 gis2 |
...
clarinetConcert = \relative c' {
  ...
  r8 gis16 cis e8 gis,16 cis e8 a,16 cis e8 a, |
  ...
  % Section B (mm. 17-24)
  cis16\ff dis e fis e8 cis cis16 dis e fis e8 cis |
  d16 e fis g fis8 d d16 e fis g fis8 d |
  gis16 bis dis fis dis8 bis fis'16 dis bis gis dis'8 gis, |
  cis2. r4 |
  r8 cis16 e e8 cis16 e e8 cis16 e e8 cis |
  r8 d16 fis fis8 d16 fis fis8 d16 fis fis8 d |
  r8 bis16 dis dis8 bis16 dis dis8 bis16 dis dis8 bis |
  cis1\ff |
  ...
  r8 gis16 bis dis8 gis,16 bis dis8 gis,16 bis dis8 gis, |
  r8 gis16 bis dis8 gis,16 bis dis8 gis,16 bis dis8 gis, |
  cis16 dis e fis e8 cis cis16 dis e fis e8 cis |
  d16 e fis g fis8 d d16 e fis g fis8 d |
...
altoSaxConcert = \relative c' {
  ...
  dis8 r dis r dis4 dis8 dis |
  e2. r4 |
  r8 e4.\f ~ e4 e8 e |
  r8 fis4. ~ fis4 fis8 fis |
...
trumpetConcert = \relative c' {
  ...
  r8 e4.\f ~ e4 e8 e |
  r8 e4. cis4. cis8 |
  bis2\f r8 bis\f dis fis |
  
  % Section A: Authentic Beethoven Theme in Brass (mm. 9-16)
...
hornConcert = \relative c' {
  ...
  a4. fis8 a4. fis8 |
  gis2. r4 |
  gis8\ff r gis r gis4 gis8 gis |
  a8 r a r a4 a8 a |
  bis8 r bis r bis4 bis8 bis |
  gis2. r4 |
  r8 gis4.\f ~ gis4 gis8 gis |
  r8 a4. ~ a4 a8 a |
  r8 bis4. bis4 bis8 bis |
  gis1\ff |
  \tempo "Adagio - Bossa Sostenuto" 4 = 68
...
\score {
  \unfoldRepeats <<
    ...
    \new Staff \with { midiInstrument = #"trombone" } { \euphoniumConcert }
