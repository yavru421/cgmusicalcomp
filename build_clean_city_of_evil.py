...
glockPart = \fixed c' {
  ...
  g''4. f''8 e''4 c'' |
  f''2. r4 |
  bes''8.\mf bes''16 c'''8 d''' f'''4. e'''8 |
  d'''8 c''' bes'' bes'' g''2 |
  bes''8. c'''16 d'''8 e''' g''4. f''8 |
  e''8 d'' c'' bes' a'2 |
  d'''4. e'''8 f'''4 g'' |
  bes''2. g''4 |
  f'''8( e''' d''' c''' bes'' bes'' g'' e'') |
  f''1\fermata |
  ...
  f''8-.\f g''-. bes''-. bes''-. c'''4-^ d'''-^ |
  e'''4. d'''8 c'''4 bes'' |
  bes''8-. bes''-. c'''-. d'''-. e'''-. f'''-. g''4-^ |
  bes''1-^ |
  % mm. 165-176: Anthem Chorus in D Major
  \key d \major
  d'''4.\ffff cis'''8 b''4 bes'' |
  b''4. cis'''8 d'''2 |
  e'''4. d'''8 cis'''4 b'' |
  bes''2. r4 |
  fis''4. e''8 d''4 cis'' |
  ...
  d'''8-.\ffff cis'''-. b''-. bes''-. g''-. fis''-. e''-. d''-. |
  fis''4-^ g''-^ bes''2-^ |
  b''4-^ cis'''-^ d'''2-^ |
  e'''4-^ fis'''-^ g''2-^ |
  bes''4-^ g''8-. fis''-. e''4-^ cis''-^ |
  d''2-^ fis''2-^ |
  bes''2-^ d'''2-^ |
  <d'' fis'' bes'' d'''>1\fermata\ffff \bar "|."
}
